...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //
    KC_A,LALT_T(KC_S),LSFT_T(KC_D),LCTL_T(KC_F),KC_G,
    KC_H,RCTL_T(KC_J),RSFT_T(KC_K),LALT_T(KC_L),KC_SCLN,
    //
    ...
    //
    KC_F5,LALT_T(KC_F6),LSFT_T(KC_F7),LCTL_T(KC_F8),UC_NEXT,
    KC_DOT,RCTL_T(KC_4),RSFT_T(KC_5),LALT_T(KC_6),KC_PMNS,
    //
