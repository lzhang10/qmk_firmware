...
KC_ESC,  U_WEB,  M_CODE,   U_TERM,  U_WEB2,  U_EMACS,   KC_F6,   KC_F7,   KC_F8,      KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_MUTE, KC_VOLD, KC_VOLU,  XXX,  XXX,
                          KC_EQL, KC_1,   KC_2,    KC_3,    KC_4,     KC_5,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS,
                        CW_TOGG, KC_Q,   KC_W,    KC_E,    KC_R,     KC_T,      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_SCLN,
                       CTRL_PGDN, MTLGUI, MTLALT,  MTLSFT,  MTLCTL,   KC_G,      KC_H,    MTRCTL,  MTRSFT,  MTRALT,  KC_MINS,  KC_QUOT,
