...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_magic(
KC_ESC,  U_WEB,M_CODE,U_WEB2,U_TERM,U_EMACS, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,  KC_F12, XXX,
...
KC_LCTL, KC_LALT,CPY_CUT,         SPACE_FN,        PASTE, KC_LALT,               KC_LEFT, KC_DOWN, KC_RGHT
),
    [NAV] = LAYOUT_magic(
