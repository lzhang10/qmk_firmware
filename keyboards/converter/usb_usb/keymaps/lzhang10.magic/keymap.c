...
// ALTAB_APP_W is a custom keycode defined in my_keycode.h that trigger Alt+` to switch application window on Mac
// using Altab App

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [BASE] = LAYOUT_magic(
ALTAB_APP_W,    U_WEB,U_CODE,U_CODE2,U_WEB2, U_FILE, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,  KC_F12, XXX,
...
KC_LCTL,  MS_BTN4, CPY_CUT,         SPACE_FN,        PASTE, MS_BTN4,             KC_LEFT, KC_DOWN, KC_RGHT
),
    [NAV] = LAYOUT_magic(
...
TRNS, TRNS,  U_CHAT,TRNS,U_WEB2,U_TERM, TRNS,   MS_WHLU,  KC_PGUP,  TRNS,  TRNS, TRNS, TRNS,TRNS,
TRNS, TRNS,  TRNS,  U_CODE,U_WEB, U_MAIL,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  TRNS,  TRNS,     TRNS,
TRNS, TRNS,  TRNS,  TRNS,  TRNS,  U_EMACS,  MS_WHLD, KC_PGDN, TRNS, TRNS,  TRNS,   TRNS,    WIN_M,
